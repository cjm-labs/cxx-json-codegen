...
int main() {
    ...
    }
    {
        ...
        FieldType map_string_int_type{FieldTypeKind::Map,
                                      "std::map<std::string, int>",
                                      "std::map",
                                      {string_type, int_type}};
        assert(map_string_int_type.kind == FieldTypeKind::Map);
        assert(map_string_int_type.arguments.size() == 2);
        assert(map_string_int_type.arguments[0].kind == FieldTypeKind::String);
