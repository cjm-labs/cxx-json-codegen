...
After the v0.3.0 release, CJM was dogfooded in a real downstream CMake project:

- [lmingzhi618/ull-md-engine](https://github.com/lmingzhi618/ull-md-engine)

The downstream experiment consumed CJM through the public workflow:
...
The downstream tests passed without requiring CJM internals or private
integration paths.

See [the ull-md-engine dogfood report](../dogfood/ull-md-engine-v0.3.0.md) for
details.
...
The initial dogfood pass completed after v0.3.0, giving downstream projects a
real release tag to consume and giving CJM adoption friction to address before
v1.0.
